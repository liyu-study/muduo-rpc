...
static void InitDefaultsscc_info_GetFriendListsRequest_test_2eproto() {
  ...
  {
    void* ptr = &::fix::_GetFriendListsRequest_default_instance_;
    new (ptr) ::fix::GetFriendListsRequest();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fix::GetFriendListsRequest::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_GetFriendListsResponse_test_2eproto() {
  ...
  {
    void* ptr = &::fix::_GetFriendListsResponse_default_instance_;
    new (ptr) ::fix::GetFriendListsResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fix::GetFriendListsResponse::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_user_test_2eproto() {
  ...
  {
    void* ptr = &::fix::_user_default_instance_;
    new (ptr) ::fix::user();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fix::user::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fix::LoginResponse, success_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fix::GetFriendListsRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fix::GetFriendListsRequest, userid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fix::user, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fix::user, name_),
  PROTOBUF_FIELD_OFFSET(::fix::user, age_),
  PROTOBUF_FIELD_OFFSET(::fix::user, sex_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fix::GetFriendListsResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fix::GetFriendListsResponse, result_),
  PROTOBUF_FIELD_OFFSET(::fix::GetFriendListsResponse, friend_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fix::ResultCode)},
  { 7, -1, sizeof(::fix::LoginRequest)},
  { 14, -1, sizeof(::fix::LoginResponse)},
  { 21, -1, sizeof(::fix::GetFriendListsRequest)},
  { 27, -1, sizeof(::fix::user)},
  { 35, -1, sizeof(::fix::GetFriendListsResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fix::_GetFriendListsRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fix::_user_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fix::_GetFriendListsResponse_default_instance_),
};

const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\ntest.proto\022\003fix\"-\n\nResultCode\022\017\n\007errco"
  "de\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\")\n\014LoginRequest"
  "\022\014\n\004name\030\001 \001(\014\022\013\n\003pwd\030\002 \001(\014\"A\n\rLoginResp"
  "onse\022\037\n\006result\030\001 \001(\0132\017.fix.ResultCode\022\017\n"
  "\007success\030\002 \001(\010\"\'\n\025GetFriendListsRequest\022"
  "\016\n\006userid\030\001 \001(\r\"X\n\004user\022\014\n\004name\030\001 \001(\014\022\013\n"
  "\003age\030\002 \001(\r\022\032\n\003sex\030\003 \001(\0162\r.fix.user.Sex\"\031"
  "\n\003Sex\022\007\n\003MAN\020\000\022\t\n\005WOMAN\020\001\"Y\n\026GetFriendLi"
  "stsResponse\022\037\n\006result\030\001 \001(\0132\017.fix.Result"
  "Code\022\036\n\013friend_list\030\002 \003(\0132\t.fix.user2\213\001\n"
  "\016UserServiceRpc\022.\n\005Login\022\021.fix.LoginRequ"
  "est\032\022.fix.LoginResponse\022I\n\016GetFriendList"
  "s\022\032.fix.GetFriendListsRequest\032\033.fix.GetF"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, descriptor_table_protodef_test_2eproto, "test.proto", 551,
...
ResultCode::ResultCode(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:fix.ResultCode)
}
...
LoginRequest::LoginRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fix.LoginRequest)
}
...
LoginResponse::LoginResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fix.LoginResponse)
}
...
GetFriendListsRequest::GetFriendListsRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fix.GetFriendListsRequest)
}
GetFriendListsRequest::GetFriendListsRequest(const GetFriendListsRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  userid_ = from.userid_;
  // @@protoc_insertion_point(copy_constructor:fix.GetFriendListsRequest)
}
...
GetFriendListsRequest::~GetFriendListsRequest() {
  // @@protoc_insertion_point(destructor:fix.GetFriendListsRequest)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:fix.GetFriendListsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsRequest::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fix.GetFriendListsRequest)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fix.GetFriendListsRequest)
  return target;
}

size_t GetFriendListsRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fix.GetFriendListsRequest)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:fix.GetFriendListsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsRequest>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fix.GetFriendListsRequest)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fix.GetFriendListsRequest)
    MergeFrom(*source);
  }
}

void GetFriendListsRequest::MergeFrom(const GetFriendListsRequest& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fix.GetFriendListsRequest)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:fix.GetFriendListsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:fix.GetFriendListsRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
user::user(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fix.user)
}
user::user(const user& from)
  ...
  // @@protoc_insertion_point(copy_constructor:fix.user)
}
...
user::~user() {
  // @@protoc_insertion_point(destructor:fix.user)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void user::Clear() {
// @@protoc_insertion_point(message_clear_start:fix.user)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          ...
          CHK_(ptr);
          _internal_set_sex(static_cast<::fix::user_Sex>(val));
        } else goto handle_unusual;
        continue;
      default: {
      handle_unusual:
...
::PROTOBUF_NAMESPACE_ID::uint8* user::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fix.user)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fix.user)
  return target;
}

size_t user::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fix.user)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:fix.user)
  GOOGLE_DCHECK_NE(&from, this);
  const user* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<user>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fix.user)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fix.user)
    MergeFrom(*source);
  }
}

void user::MergeFrom(const user& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fix.user)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:fix.user)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:fix.user)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void GetFriendListsResponse::InitAsDefaultInstance() {
  ::fix::_GetFriendListsResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fix::ResultCode*>(
      ::fix::ResultCode::internal_default_instance());
}
class GetFriendListsResponse::_Internal {
 public:
  static const ::fix::ResultCode& result(const GetFriendListsResponse* msg);
};
...
GetFriendListsResponse::GetFriendListsResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fix.GetFriendListsResponse)
}
GetFriendListsResponse::GetFriendListsResponse(const GetFriendListsResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:fix.GetFriendListsResponse)
}
...
GetFriendListsResponse::~GetFriendListsResponse() {
  // @@protoc_insertion_point(destructor:fix.GetFriendListsResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
// @@protoc_insertion_point(message_clear_start:fix.GetFriendListsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fix.GetFriendListsResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fix.GetFriendListsResponse)
  return target;
}

size_t GetFriendListsResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fix.GetFriendListsResponse)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:fix.GetFriendListsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fix.GetFriendListsResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fix.GetFriendListsResponse)
    MergeFrom(*source);
  }
}

void GetFriendListsResponse::MergeFrom(const GetFriendListsResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fix.GetFriendListsResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:fix.GetFriendListsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:fix.GetFriendListsResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void UserServiceRpc::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fix::GetFriendListsRequest*,
                         ::fix::GetFriendListsResponse*,
                         ::google::protobuf::Closure* done) {
  ...
  switch(method->index()) {
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fix::GetFriendListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fix::GetFriendListsResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fix::GetFriendListsRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fix::GetFriendListsResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fix::ResultCode* Arena::CreateMaybeMessage< ::fix::ResultCode >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fix::ResultCode >(arena);
}
template<> PROTOBUF_NOINLINE ::fix::LoginRequest* Arena::CreateMaybeMessage< ::fix::LoginRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fix::LoginRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::fix::LoginResponse* Arena::CreateMaybeMessage< ::fix::LoginResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fix::LoginResponse >(arena);
}
template<> PROTOBUF_NOINLINE ::fix::GetFriendListsRequest* Arena::CreateMaybeMessage< ::fix::GetFriendListsRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fix::GetFriendListsRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::fix::user* Arena::CreateMaybeMessage< ::fix::user >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fix::user >(arena);
}
template<> PROTOBUF_NOINLINE ::fix::GetFriendListsResponse* Arena::CreateMaybeMessage< ::fix::GetFriendListsResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fix::GetFriendListsResponse >(arena);
}
